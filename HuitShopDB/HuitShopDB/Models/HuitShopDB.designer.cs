...
namespace HuitShopDB.Models
{
    ...
    partial void Insertreview_response(review_response instance);
    partial void Updatereview_response(review_response instance);
    partial void Deletereview_response(review_response instance);
    ...
    partial void Deletewarehouse(warehouse instance);
		...
		public HuitShopDBDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["HuitShopDBConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<review_response> review_responses
		{
			get
			{
				return this.GetTable<review_response>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.review_responses")]
	public partial class review_response : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void Onupdated_atChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="review_review_response", Storage="_review", ThisKey="review_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._review.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.review_responses.Remove(this);
					}
					this._review.Entity = value;
					if ((value != null))
					{
						value.review_responses.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_review_response", Storage="_user", ThisKey="admin_id", OtherKey="id", IsForeignKey=true)]
		public user user
		{
			get
			{
	...
	public partial class review : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<review_response> _review_responses;
    ...
    partial void Onupdated_atChanged();
		...
		public review()
		{
			this._review_responses = new EntitySet<review_response>(new Action<review_response>(this.attach_review_responses), new Action<review_response>(this.detach_review_responses));
			this._product = default(EntityRef<product>);
			this._product_variant = default(EntityRef<product_variant>);
			this._user = default(EntityRef<user>);
			OnCreated();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="review_review_response", Storage="_review_responses", ThisKey="id", OtherKey="review_id")]
		public EntitySet<review_response> review_responses
		{
			get
			{
				return this._review_responses;
			}
			set
			{
				this._review_responses.Assign(value);
			}
		}
		...
		private void attach_review_responses(review_response entity)
		{
			this.SendPropertyChanging();
			entity.review = this;
		}
		
		private void detach_review_responses(review_response entity)
		{
			this.SendPropertyChanging();
			entity.review = null;
		}
    ...
    partial void Onupdated_atChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_review_response", Storage="_review_responses", ThisKey="id", OtherKey="admin_id")]
		public EntitySet<review_response> review_responses
		{
			get
			{
